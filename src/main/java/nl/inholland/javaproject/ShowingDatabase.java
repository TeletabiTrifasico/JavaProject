...
public class ShowingDatabase {
    ...
    public ShowingDatabase() {
        ...
        if (showings.isEmpty()) {
            showings.add(new Showing("Avengers", "2024-12-01 14:00", "2024-12-01 16:30", 72, false));
            showings.add(new Showing("Inception", "2024-12-01 17:00", "2024-12-01 19:30", 72, true));
            showings.add(new Showing("Titanic", "2024-12-01 20:00", "2024-12-01 23:00", 72, true));
        }
    }
